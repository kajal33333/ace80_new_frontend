...
const AddCategory = ({ type }) => {
    ...
    const getCategory = async (id) => {
        try {
            const response = await instance.get(`/enquiryCustomerCategory?id=${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (type === "Edit") {
                await instance.put(`/enquiryCustomerCategory?id=${id}`, payload);

                showSuccess(response?.data?.message || "Category updated successfully!");
            } else {
                response = await instance.post("/enquiryCustomerCategory", payload);
                showSuccess(response?.data?.message || "Category created successfully!");
            }
